          ...
          <>
            ...
            <div ref={(el) => { if (el) wrapperRefs.current['/integrations' as NavTo] = el }}>
              ...
              >
                {({ isActive }) => (
                  <>
                    <Webhook style={{ width: '16px', height: '16px', color: isActive ? '#f0ede5' : '#9a9a9a', transition: 'color 0.2s ease', flexShrink: 0 }} />
                    {!collapsed && <span className="sidebar-label" style={{ flex: 1 }}>Integrações</span>}
                  </>
                )}
              </NavLink>
            </div>
