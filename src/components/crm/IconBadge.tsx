...
const COLOR_MAP: Record<IconBadgeColor, { bg: string; bgDark: string; color: string; colorDark: string }> = {
  ...
  success: { bg: 'rgba(21,128,61,0.10)',  bgDark: 'rgba(21,128,61,0.15)',  color: '#2c5545', colorDark: '#5aaa88' },
  warning: { bg: 'rgba(146,64,14,0.10)',  bgDark: 'rgba(180,83,9,0.15)',   color: '#a88030', colorDark: '#c9a040' },
  danger:  { bg: 'rgba(155,28,28,0.10)',  bgDark: 'rgba(185,28,28,0.15)',  color: '#c94444', colorDark: '#f87171' },
